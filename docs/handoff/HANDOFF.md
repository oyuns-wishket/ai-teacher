...
> 진행 중 발견한 예상 밖 문제. 마킹만 하고 계속 진행 → 작업 완료 후 사용자와 리뷰·개선. (프로토콜: 취조식 인터뷰 · 복병 마킹 · 완료 후 이해도 퀴즈 5문항)

- [ ] (2026-07-09) 기초 3명 클로드 미사용 — 교육 도구와 실사용 도구 불일치. GPT 투트랙으로 갈지, 클로드 결제 유도할지 미정.
- [ ] (2026-07-09) 레포 PUBLIC 상태로 SSOT(실명 인터뷰 상세)가 GitHub에 노출 중 — 사용자 "일단 두기" 결정했으나 재검토 여지.
